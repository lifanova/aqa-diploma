...
Шаги:  
1. Ввести в поле "Номер карты" корректный номер по маске ввода (например, 1234 5678 9090 1234).  
...
Шаги:  
1. Ввести в поле "Номер карты" номер (например, 1234 5678 9090 1234).  
...
Необходимое время на тестирование веб-сервиса составляет 5-8 дней, с учетом рисков - 7-9 дней.

### План сдачи работ
1. Планирование - 1-2 дня
2. Реализация автотестов и работа со структурой БД по результатам документа о планировании- 7-8 дней.
3. Модификацификации, исправления и рефакторинг по результатам замечаний - 2-3 дня